export namespace ExpectedExports {
    ...
    export type health = {
        ...
        [id: string]: (effects: Effects, timeStampMs: number) => Promise<ResultType<null | void>>;
    }
}
...
export type KnownError = { error: String } | { 'error-code': [number, string] | readonly [number, string] }
